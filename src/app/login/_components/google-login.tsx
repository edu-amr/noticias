...
export function GoogleLogin() {
  ...
  return (
    <form action={loginWithGoogle}>
      <button
        className={cn([
          "transition-all duration-300 flex items-center justify-center gap-[8px] px-[24px] border rounded-full transform active:scale-90 border-G030 hover:opacity-[80%] mt-[64px] w-full",
        ])}
      >
        <svg
          width="48"
